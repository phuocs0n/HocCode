...
This is the syntax of fetch():

```javascript
// request data from a server
const data = fetch('https://api.programiz.pro/api/Demo/javascript/movies')
```

Here is how it works:

- Making a Request: The fetch() function sends a request to the specified URL.
- Receiving a Response: It waits for the server to respond with data.
