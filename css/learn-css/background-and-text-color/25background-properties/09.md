# Use Case of Background Repetition

#### Course: Learn CSS

## Use Case of Background Repetition

We often use background-repeat: no-repeat; to prevent repetition, but in some cases, repeating backgrounds can be useful.

For example, repeating a small image, like a geometric pattern or texture, can help you create a continuous background without needing a large image file.
...
```css
1div {
2    background-image: url('/images/learn-css/bg3.png');
3
4    background-repeat: no-repeat; 
5}
```

Remove the background-repeat: no-repeat; in the above CSS.

You'll notice how the repeated image adds a geometric pattern to the background.
