...
This project will consist of a Game class that contains all the game components. These components are

- Member variables to store the computer's pick, the user's pick, and the game result.
- Member functions to get the computer's pick, the user's pick, and the game result.
