...
Suppose we have a graph with vertices, edges, and weights. Our goal is to make a minimum spanning tree.

Doing so with Kruskal's algorithm involves the following steps:
