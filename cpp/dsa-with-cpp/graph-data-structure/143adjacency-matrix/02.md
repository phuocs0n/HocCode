...
- aija_{ij}aij​ = 1 if vertices viv_ivi​ and vjv_jvj​ are adjacent.
- aija_{ij}aij​ = 0 if vertices viv_ivi​ and vjv_jvj​ are not adjacent.

Here,

- aija_{ij}aij​ - Element of adjacent matrix at ith row and jth column.
- v - Individual vertex.
