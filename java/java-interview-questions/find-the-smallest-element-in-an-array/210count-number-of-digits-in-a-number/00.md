...
Write a program to count the digits of a given number. For example,

```java
number = 123
output = 3
reason = There are 3 digits in the number.
```

```java
number = 54321
output = 5
reason = There are 5 digits in the number.
```

```java
number = 000000
output = 6
reason = There are 6 digits in the number.
```
