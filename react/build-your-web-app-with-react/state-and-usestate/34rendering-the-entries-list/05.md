# Render the Full List in App

#### Course: Build your First Web App with React

## Render the Full List in App

Now, let's finally update the entries section in App.jsx to map over entries. Then, we'll render one EntryCard per entry:
...
As you can see, we've removed the single <EntryCard ... /> that used entries[0]. Instead, the list is now driven entirely by the entries array.
