...
As you know, there are many built-in functions such as sum(), max(), len(), etc. that help us solve problems quickly and efficiently.

In addition to these built-in functions, using a module provides more functions that we can use in our program.
