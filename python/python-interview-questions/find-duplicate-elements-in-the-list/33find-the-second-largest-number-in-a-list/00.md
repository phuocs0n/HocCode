...
Suppose we have a list of numbers. Now, create a Python program to find the second-largest number from the list.
...
Here, the second largest element from the list is 23.
