# Give a simple example of an SQL trigger

#### Course: SQL Interview Questions

## Give a simple example of an SQL trigger

An SQL trigger is a code that automatically executes when a specific event occurs in a database management system, such as inserting, updating, or deleting data.
